"""Drive the deployed gemini-bright-vertex Cloud Run app through Playwright,
...
URL = "https://gemini-bright-vertex-1029931682737.us-central1.run.app/"
OUT_DIR = Path("/Users/ubl/gemini-bright-vertex/.video-build")
...
def main() -> int:
    ...
    with sync_playwright() as p:
        ...
        page.wait_for_selector("text=gemini-bright-vertex", timeout=60_000)
